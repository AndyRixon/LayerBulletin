...
<br /><br />
		<table class="forum-board-forum-head" cellpadding="0" cellspacing="0">
			...
			<tr><td class="forum-index-stats-sub">
				<form method="post" action="<?php echo "$lb_domain"; ?>/index.php?page=admin&act=modules&alter=rss">
					<select name="order">
...
<?php }elseif($template_hook=='11'){ ?>	
							...
							<span style="text-align: right;">
								<a class="submit-button img-upload" href="<?php echo "$lb_domain"; ?>/index.php?page=admin&act=modules&func=remote&file=
...
<?php }elseif($template_hook=='13'){ ?>
				<div style="width:100%; text-align: right";>
					<a href="http://plugins.layerbulletin.com"><strong><?php echo $lang_admin['modules_more']; ?></strong></a>
				</div>
				...
				<table class="forum-board" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="forum-index-stats-header forum-index-top" style="text-align: center;">
							<form name="warn" action="<?php echo "$lb_domain"; ?>/index.php?page=admin&act=modules&func=<?php echo "$func"; ?>&file=<?php echo "$file"; ?>&module=<?php echo "$modulename"; ?>" method="post">
